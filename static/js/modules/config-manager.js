    ...
    const config = {
        autoinstall: {
            ...
            apt: {
                ...
                geoip: document.getElementById('aptGeoIP')?.value === 'true' || true,
            ...
            ssh: {
                "allow-pw": document.getElementById('sshAllowPW')?.value === 'true' || true,
                "authorized-keys": document.getElementById('sshKeys')?.value?.split('\n').filter(k => k.trim()) || [],
                "install-server": document.getElementById('sshInstallServer')?.value === 'true' || true
            },
            storage: {
                config: [],
                swap: {
